 ...
 *      Author: Yuxia Sheng
 *      Code is from http://cis.poly.edu/cs3224a/Code/ProducerConsumerUsingPthreads.c
 *      producer consumer problem in pthread
...
void* producer(void *ptr) {
  ...
  for (i = 1; i <= MAX; i++) {
    ...
    buffer = i;
    printf("producer buffer round : %d\n", i);
...
void* consumer(void *ptr) {
  ...
  for (i = 1; i <= MAX; i++) {
    ...
    buffer = 0;
    printf("consumer buffer round : %d\n", i);
